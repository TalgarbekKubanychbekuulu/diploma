...
function Products2 () {
  return (
    <>
			...
			<label for="tab1"><span>Code</span></label>

			<input id="tab2" type="radio" name="tabs" />
			<label for="tab2"><span>About</span></label>

			<input id="tab3" type="radio" name="tabs" />
			<label for="tab3"><span>Services</span></label>

			<input id="tab4" type="radio" name="tabs" />
			<label for="tab4"><span>Portfolio</span></label>

			<input id="tab5" type="radio" name="tabs" />
			<label for="tab5"><span>Contact</span></label>
